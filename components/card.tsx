...
const Card = ({ product, onDelete }) => {
  ...
  const truncateDescription = (description: string) => {
    return description.length > 50 ? description.substring(0, 29) + " ..." : description;
  };
    ...
    <StyledWrapper>
      <Dialog>
        ...
        <DialogContent className="rounded-lg">
          <DialogHeader>
            <DialogTitle className="text-center text-2xl font-bold">{product.name}</DialogTitle>
          </DialogHeader>
          <div className="grid grid-cols-2 gap-4 mt-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              <p><strong>Quantity Left:</strong> {product.stockquantity}</p>
              <p><strong>Description:</strong> {product.description}</p>
              <p><strong>Location ID:</strong> {product.locationid}</p>
